package com.baseframe.core.zhuzsdemo.aop.jdkproxy;

import com.baseframe.core.zhuzsdemo.aop.UserService;
import com.baseframe.core.zhuzsdemo.aop.UserServiceImpl;
import com.baseframe.core.zhuzsdemo.aop.annotation.UserProxy;
...
public class JdkproxyTest {
    public static void main(String[] args) {
        try {
            ...
            log.info(" declaredFields: {}", declaredFields.toString());
